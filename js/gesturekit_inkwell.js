	...
	(GestureKit = function(uiid) {	
			...
			var update_url = 'http://staging.gesturekit.com/sdk/getupdate/inkwell/' + uiid;				
			$.ajax({
				url: update_url,
				type: "GET",    
				dataType: 'json',		
				success: function (data) { 			
					...
					if (local_html!=html_update){
						...
						var html_url = 'http://staging.gesturekit.com/sdk/gethtml/inkwell/' + uiid;	
					...
					$.ajax({
						...
						success: function(response) {																							
								...
								if (typeof(load_graphics_and_listeners) != "undefined") { 									
									load_graphics_and_listeners(gesturekit_container);
								}	
